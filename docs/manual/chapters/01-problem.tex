...
\begin{itemize}
  \item per-file allocated bytes for sparse files and decmpfs-
    compressed files (chapter~8 covers the five case classes that do
    have on-disk oracle support; the other two fail closed);
