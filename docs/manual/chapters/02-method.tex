...
plus the reference is harder to fault than the reference alone. For
performance claims the same convergence pattern applies across
independent fast macOS scanners (\texttt{dumac}, \texttt{macdirstat},
\texttt{jwalk}) and the xnu kernel source itself.
