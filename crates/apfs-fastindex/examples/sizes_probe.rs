use apfs_fastindex::{NamespaceEntry, EntryKind};
use apfs_fastindex::tree::{Tree, TreeNode};

fn main() {
    println!("size_of NamespaceEntry = {}", std::mem::size_of::<NamespaceEntry>());
    println!("align_of NamespaceEntry = {}", std::mem::align_of::<NamespaceEntry>());
    ...
    println!("size_of Option<String> = {}", std::mem::size_of::<Option<String>>());
    println!("size_of Option<Box<str>> = {}", std::mem::size_of::<Option<Box<str>>>());
